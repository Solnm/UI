...
export const mintText = [
  ...
  { label: "default", mintText: "", buttonLabel: "MINT", header: "Public mint"}
];

//header image in the ui. replace with your own
export const image = "https://i.imgur.com/bKKUjf5.png";
export const linkedin = "https://i.imgur.com/sLoQWpD.png";
export const twitter = "https://i.imgur.com/4GOXf25.png";
export const discord = "https://i.imgur.com/LpIILb8.png";
export const github = "https://i.imgur.com/DUhpjOQ.png";
